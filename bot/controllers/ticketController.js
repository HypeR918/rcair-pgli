...
export function registerTicketActions(bot) {
  ...
  bot.action('menu:new', async ctx => {
    ...
    try {
      ...
      await ctx.reply(
        [
          'Обозначьте тему заявки',
          '',
          'Чтобы заявка была обработана в самые короткие сроки, обязательно укажите префикс-ключевое слово, например:',
          '<i>«<b>СЭД</b>: смена пароля»,',
          '«<b>АРМ</b>: не включается компьютер»,',
          '«<b>Сеть</b>: нет доступа в Интернет»,',
          '«<b>Почта</b>: не приходит письмо»,',
          '«<b>СМЭВ</b>: не открывается страница сайта»,',
          '«<b>Безопасность</b>: касперский нашел вирус» и т.п.</i>',
          '',
          'При указании корректного ключевого слова, заявка сразу направляется на нужного специалиста.',
          'Для ознакомления со всеми ключевыми словами нажмите «Справка».',
        ].join('\n'),
        { format: 'html' }
      );
    } catch (error) {
  ...
  bot.action('menu:help', async ctx => {
    await ctx.reply(
      [
        'При создании заявки в теме используйте префиксы-ключевые слова',
        'Заявки с префиксом сразу направляются на нужного специалиста без рассмотрения диспетчером',
        '',
        '<b>Существующие префиксы-ключевые слова:</b>',
        '',
        '<b>СЭД</b> или <b>МЭДО</b> - для электронного документооборота',
        '',
        '<b>АРМ</b> - для проблем с компьютером и периферией (мышь, клавиатура, принтер и т.п.)',
        '',
        '<b>Сеть</b> - для проблем с интернетом',
        '',
        '<b>Почта</b> - для проблем, связанных с электронной почтой',
        '',
        '<b>Безопасность</b> - для запросов, связанных с антивирусами и защищенным подключением (С-Терра)',
        '',
        '<b>Новый сотрудник</b> - для настройки систем, создания учетных записей, почты и доступов для нового сотрудника',
        '',
        '<b>Увольнение</b> - для блокировки учетных записей и доступов уволенного сотрудника',
        '',
        '<b>Интра</b> - для проблем, связанных с работой корпоративного портала Интра (Битрикс)',
        '',
        '<b>Портал</b> - для внесения изменений на портал исполнительных органов государственной власти (добавление НПА, изменение контактных данных)',
        '',
        '<b>Федеральные и региональные информационные системы:</b>',
        '',
        '<b>СМЭВ</b> - информационная система межведомственного электронного взаимодействия',
        '',
        '<b>ГИС ГМП</b> - государственные и муниципальные платежи',
        '',
        '<b>ПГС2</b> - Платформа государственных сервисов 2.0',
        '',
        '<b>ПГС3</b> - единая система предоставления государственных и муниципальных услуг (сервисов)',
        '',
        '<b>АРМ ЕЛК</b> - Автоматизированное рабочее место сотрудника для направления уведомлений в личный кабинет гражданина на ЕПГУ',
        '',
        '<b>ТОР КНД</b> - Контрольная (надзорная) деятельность',
        '',
        '<b>РГУ</b> - Реестр государственных услуг',
        '',
        '<b>ГАСУ</b> - Государственная автоматизированная система «Управление»',
        '',
        '<b>Перенос услуг в электронный вид (Госуслуги):</b>',
        '',
        '<b>ВКУ</b> - разработка и внесение изменений в электронную услугу',
        '',
        '<b>Робот Макс</b> - создание и внесение изменений в навыки виртуального ассистента Госуслуг',
        '',
        '<b>Лендинг</b> - создание и внесение изменений в региональные лендинги на Госуслугах',
        '',
        '<b>Адресные уведомления</b> - создание адресных региональных уведомлений',
      ].join('\n'),
      {
        format: 'html',
